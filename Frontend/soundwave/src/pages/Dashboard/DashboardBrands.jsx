...
const DashboardBrands = () => {
    ...
    const openBrandModal = (brand = null) => {
        setModal({
            ...
            fields: [
                { name: 'name', label: t.brandName, type: 'text', placeholder: t.enterBrandName, required: true },
            ],
            initialData: brand || {},
    ...
    const handleSave = async (formData) => {
        try {
            switch (modal.type) {
                case 'brand':
                    if (modal.editId) {
                        await brandService.editBrand(modal.editId, formData);
                    } else {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-5">
            ...
            <DynamicModal
                ...
                showDelete={modal.editId !== null && (modal.type === 'brand')}
            />
        </div>
    );
};
